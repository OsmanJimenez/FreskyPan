...
ALTER TABLE MateriaPrima ADD CONSTRAINT FK_ID_MEDIDACANTIDAD_MATERIAPRIMA FOREIGN KEY(FK_ID_TIPOMATERIAPRIMA) REFERENCES TipoMateriaPrima(ID_TIPOMATERIAPRIMA) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE MateriaPrima ADD CONSTRAINT FK_ID_TIPOMATERIAPRIMA_MateriaPrima FOREIGN KEY(FK_ID_TIPOMATERIAPRIMA) REFERENCES TipoMateriaPrima(ID_TIPOMATERIAPRIMA) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE Insumo ADD CONSTRAINT FK_ID_TIPOINSUMO_INSUMO FOREIGN KEY(FK_ID_TIPOINSUMO) REFERENCES TipoInsumo(ID_TIPOINSUMO) ON UPDATE CASCADE ON DELETE CASCADE;
