            ...
            <form action="../basededatos/agregad.php" method="POST">
              <div class="form-row">
                <div class="form-group col-md-8">
                  ...
                  <input type="text" name="cd" class="form-control" id="inputName" maxlength="11" oninput="maxlengthNumber(this)" onkeypress="return cod_dev(event)"  onpaste="return false" placeholder="" required="">
                </div>
...
<script>
 ...
 var flag=1;
    ...
    <!-- validacion de longitud de campo-->
