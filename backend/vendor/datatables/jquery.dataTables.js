...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoFiltered": " - Filtrando desde _MAX_ records"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "processing": "Base de datos actualmente ocupada"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "search": "Aplicar busqueda_INPUT_ to table"
			 *        }
			 *      } );
			 *    } );
			 */
