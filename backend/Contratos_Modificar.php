              ...
              <form action="../basededatos/actuaco.php" method="POST">
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="cod" class="form-control" value="<?php echo $code;?>" readonly=""
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="fec" value="<?php echo $fec_ent;?>" class="form-control" id="inputName"
                      placeholder="">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="inputName">Hora de Entrega</label>
                    <input type="text" name="hor" value="<?php echo $hor_ent;?>" class="form-control" id="inputName"
                      placeholder="">
                  </div>
                </div>
                <div class="form-row">
