...
$i = 0;
        ...
        $i++; ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-11">
                ...
                <input type="number" name="cod" class="form-control" id="inputName" value="<?php echo $codigo;?>" oninput="maxlengthNumber(this)" onkeypress="return cod_emp(event)" onpaste="return false"  placeholder="" readonly="">
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="nom" value="<?php echo $nombre;?>" class="form-control" id="inputName" onkeypress="return validarNom(event)"  onpaste="return false" placeholder="">
                </div>
                <div class="form-group col-md-6">
                  <label for="inputPrice">Apellido del Empleado</label>
                  <input type="text" name="ape" class="form-control" value="<?php echo $apellido;?>" id="inputrice" onkeypress="return validarAp(event)"  onpaste="return false" placeholder="">
                </div>
              </div>
      ...
      <!-- validacion de campos numericos y longitud -->
      <script>
