...
$can=$_POST['can'];	
$fec=$_POST['fec'];
$query89="select catproducto.nombre from produccion,catproducto,venta where ID_PRODUCCION='$idp' and produccion.FK_ID_CATPRODUCTO=catproducto.ID_CATPRODUCTO";
