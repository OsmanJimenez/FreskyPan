...
$i = 0;
		...
		<tr align="center">
			<td><input type="radio" name="" id="r1" onclick="cambia(<?php echo $codc;?>)"></td>
			<td><?php echo $tip; ?></td>
			<td><?php echo $cod; ?></td>
			<td><?php echo $fec; ?></td>
			...
			<td><?php echo $fec_ent; ?></td>
             ...
             if($est==1){
              ...
              ?></td>
			<td><a class="btn btn-success" href="Contratos_Modificar.php?id3=<?php echo $codc; ?>">Editar</a></td>
			<td><a class="btn btn-danger" href="../basededatos/cam_est4.php?id3=<?php echo $codc; ?>">Cambiar de estado</a></td>
		</tr>
<?php }?>