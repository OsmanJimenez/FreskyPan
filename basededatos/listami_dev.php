...
<?php }
		...
		<tr align="center">
			<td><input type="checkbox" name="check_mi[]" id="check_mi" class="check" value="<?php echo $idin; ?>"></input></td>
			<td><?php echo $nomi; ?></td>
